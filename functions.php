<?php
/**
 * amc-theme functions and definitions
 *
...
if ( ! function_exists( 'amc_theme_setup' ) ) :
	/**
	...
	function amc_theme_setup() {
		 ...
		 * If you're building a theme based on amc-theme, use a find and replace
		 * to change 'amc-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'amc-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'amc-theme' ),
				'menu-2' => esc_html__( 'Footer Menu', 'amc-theme' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'amc_theme_custom_background_args',
				array(
 ...
 */
function amc_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'amc_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'amc_theme_content_width', 0 );
 ...
 */
function amc_theme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'amc-theme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'amc-theme' ),
...
add_action( 'widgets_init', 'amc_theme_widgets_init' );
